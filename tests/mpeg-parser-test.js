...
var mockBuffer  = fs.readFileSync('./tests/fixtures/basic/krad.tv/tractor/fileSeq0.mp4')
...
test('that we can parse atoms from a segment', t=> {
  ...
  var parsed = MPEGParser.parse(mock)
...
test('that we can parse avc1 components', t=> {
  ...
  t.equals(avc1.width, 400, 'width value was correct')
  t.equals(avc1.height, 224, 'height value was correct')
